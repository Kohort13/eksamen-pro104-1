...
const EmployeeModule = (function(){
    ...
    const ansatte = [
        ...
        new Ansatt("male1.png", "Ola", "Nordmensch", randomPhoneNr(), "ola@nordmench.org", randomAdresss(), randomBirthDate(), "647 000kr", Positions.CHEF, RestaurantModule.getById(1)), 
        ...
        new Ansatt("male2.png", "Eddie", "Gravdal", randomPhoneNr(), "edigvalley@coldmail.com", randomAdresss(), randomBirthDate(), "465 000kr", Positions.WAITER, RestaurantModule.getById(1)), 
        ...
        //Restaurant 2
        new Ansatt("male3.png", "Bob Kåre", "Johnniebjørn", randomPhoneNr(), "bob@kåre.org", randomAdresss(), randomBirthDate(), "712 000kr", Positions.MANAGER, RestaurantModule.getById(2)),
        ...
        new Ansatt("male4.png", "Gustav", "Jonson", randomPhoneNr(), "gustav.jonson@coldmail.com", randomAdresss(), randomBirthDate(), "587 000kr", Positions.ASS_CHEF, RestaurantModule.getById(2)), 
        ...
        new Ansatt("male5.png","Petter", "Måneberg", randomPhoneNr(), "its_not_the_fart@coldmail.com", randomAdresss(), randomBirthDate(), "465 000kr", Positions.WAITER, RestaurantModule.getById(2)), 
        ...
        //Restaurant 3
        new Ansatt("male6.png","Adrian", "Overgård", randomPhoneNr(), "aoverg@coldmail.com", randomAdresss(), randomBirthDate(), "712 000kr", Positions.MANAGER, RestaurantModule.getById(3)), 
        ...
        new Ansatt("male7.png", "David", "Olssen", randomPhoneNr(), "d.olssen@coldmail.com", randomAdresss(), randomBirthDate(), "587 000kr", Positions.ASS_CHEF, RestaurantModule.getById(3)), 
        ...
        new Ansatt("male8.png", "Fredrik", "Al'Égie", randomPhoneNr(), "f.uck@coldmail.com", randomAdresss(), randomBirthDate(), "465 000kr", Positions.WAITER, RestaurantModule.getById(3)), 
        ...
        //Restaurant 4
        new Ansatt("male9.png", "Javier", "Gonzales", randomPhoneNr(), "jgone@coldmail.com", randomAdresss(), randomBirthDate(), "712 000kr", Positions.MANAGER, RestaurantModule.getById(4)), 
        ...
        new Ansatt("male10.png", "Jesper", "Hoyt", randomPhoneNr(), "yawnie@coldmail.com", randomAdresss(), randomBirthDate(), "587 000kr", Positions.ASS_CHEF, RestaurantModule.getById(4)), 
        ...
        new Ansatt("male11.png","Lars", "Larsen", randomPhoneNr(), "lars1@coldmail.com", randomAdresss(), randomBirthDate(), "465 000kr", Positions.WAITER, RestaurantModule.getById(4)), 
